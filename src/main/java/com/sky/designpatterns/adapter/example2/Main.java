...
public class Main {
    public static void main(String[] args) {
        ...
        // The downloadFileFromInternet method inside fileDownloader used a object of type phone
        ...
        // We create an interface of the type phone and add abstract method equavlent to the method being used inside fileDownloader called off the phone
